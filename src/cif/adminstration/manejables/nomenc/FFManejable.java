...
import cif.gui.nomencladores.FFNomencPanel;
 ...
 * @author IntelI3
 */
public class FFManejable extends NomencManejable
{
    private static final int NAME = 0;
    public FFManejable(JF_Principal princ)
    {
        super(princ);
    }
    ...
    public void Insert()
    {
        FFNomencPanel mp = new FFNomencPanel();
    ...
    public void Modify()
    {
        if(Utils.isTable(parent.getPrincipalComponent()))
        {
            ...
            FFNomencPanel mp = new FFNomencPanel(name);
            parent.setComponent(mp);
        }
    }
    ...
    public void Delete()
    {
        ...
        {
            id=DBQueries.getNomencId("c3_1_1_formacionforestal",name[i]);
            DBQueries.UpdateNomenc("c3_1_1_formacionforestal",id,name[i],"false");
    ...
    public JTable Report() {
        return DBQueries.getAllNomenc("c3_1_1_formacionforestal");
    }
