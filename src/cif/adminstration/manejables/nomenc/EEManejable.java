...
import cif.gui.nomencladores.EENomencPanel;
 ...
 * @author IntelI3
 */
public class EEManejable extends NomencManejable
{
    private static final int NAME = 0;
    public EEManejable(JF_Principal princ)
    {
        super(princ);
    }
    ...
    public void Insert()
    {
        EENomencPanel mp = new EENomencPanel();
    ...
    public void Modify()
    {
        if(Utils.isTable(parent.getPrincipalComponent()))
        {
            ...
            EENomencPanel mp = new EENomencPanel(name);
            parent.setComponent(mp);
        }
    }
    ...
    public void Delete()
    {
        ...
        {
            id=DBQueries.getNomencId("c3_1_2_especendem",name[i]);
            DBQueries.UpdateNomenc("c3_1_2_especendem",id,name[i],"false");
    ...
    public JTable Report() {
        return DBQueries.getAllNomenc("c3_1_2_especendem");
    }
