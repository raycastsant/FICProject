...
import cif.gui.nomencladores.ProgProtNomencPanel;
 ...
 * @author IntelI3
 */
public class ProgProtManejable extends NomencManejable
{
    private static final int NAME = 0;
    public ProgProtManejable(JF_Principal princ)
    {
        super(princ);
    }
    ...
    public void Insert()
    {
        ProgProtNomencPanel mp = new ProgProtNomencPanel();
    ...
    public void Modify()
    {
        if(Utils.isTable(parent.getPrincipalComponent()))
        {
            ...
            ProgProtNomencPanel mp = new ProgProtNomencPanel(name);
            parent.setComponent(mp);
        }
    }
    ...
    public void Delete()
    {
        ...
        {
            id=DBQueries.getNomencId("c3_1_3_ejecprogprotec",name[i]);
            DBQueries.UpdateNomenc("c3_1_3_ejecprogprotec",id,name[i],"false");
    ...
    public JTable Report() {
        return DBQueries.getAllNomenc("c3_1_3_ejecprogprotec");
    }
