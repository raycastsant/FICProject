...
import cif.gui.nomencladores.CategNomencPanel;
 ...
 * @author IntelI3
 */
public class CategManejable extends NomencManejable
{
    private static final int NAME = 0;
    public CategManejable(JF_Principal princ)
    {
        super(princ);
    }
    ...
    public void Insert()
    {
        CategNomencPanel mp = new CategNomencPanel();
    ...
    public void Modify()
    {
        if(Utils.isTable(parent.getPrincipalComponent()))
        {
            ...
            CategNomencPanel mp = new CategNomencPanel(name);
            parent.setComponent(mp);
        }
    }
    ...
    public void Delete()
    {
        ...
        {
            id=DBQueries.getNomencId("c5_5_catgocupacional",name[i]);
            DBQueries.UpdateNomenc("c5_5_catgocupacional",id,name[i],"false");
    ...
    public JTable Report() {
        return DBQueries.getAllNomenc("c5_5_catgocupacional");
    }
