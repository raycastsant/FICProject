...
// public static final String C_2_1_2_IncendEspecie           = "C_2_1_2_IncendEspecie";
 ...
 public static JTable mostrar_Reporte(String criterio, User user, int anno, boolean desglose, BaseUnits bu) throws SQLException
 {
     JTable tm = null;
     
        try {
            IReportModel reportModel = (IReportModel) Class.forName("cif.reportes.clases."+criterio+"_Model").newInstance();
            tm = reportModel.getModel(user, anno, desglose, bu);
