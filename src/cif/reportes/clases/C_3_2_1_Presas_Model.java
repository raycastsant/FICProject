...
* @author Raisel
*/
public class C_3_2_1_Presas_Model extends AbstractCritReport
{
 ...
 {
    String sql = getSQLReplacement(ReportQuerys.SQL_3_2_1_US, user.getIdEntidad(), anno.toString());
 ...
 {
   String sql = getSQLReplacement(ReportQuerys.SQL_3_2_1_AP, user.getIdEntidad(), anno.toString());
   db.executeQueryUperCase(sql);
 ...
 protected TableModel getModel_EFI()
 {
    ...
    String sql = getSQLReplacement(ReportQuerys.SQL_3_2_1_EFI_Subgrupo, user.getIdEntidad(), anno.toString());
    db.executeQueryUperCase(sql);
    if(!db.isEmpty())
    {
     tm = new javax.swing.table.DefaultTableModel(db.getAllRows(), db.getColumnNames());

     sql = getSQLReplacement(ReportQuerys.SQL_3_2_1_EFI_TOTAL, user.getIdEntidad(), anno.toString());
     db.executeQuery(sql);
 ...
 protected TableModel getModel_MUN()
 {
       ...
       String sql = getSQLReplacement(ReportQuerys.SQL_3_2_1_MUN_SubGrupoUS, user.getIdEntidad(), anno.toString());
       db.executeQuery(sql);
       if(!db.isEmpty())
       {
       ...
       sql = getSQLReplacement(ReportQuerys.SQL_3_2_1_MUN_SubGrupoAP, user.getIdEntidad(), anno.toString());
       db.executeQuery(sql);
       if(!db.isEmpty())
       {
           mun = db.getValueAt(0,0).toString();
       ...
       sql = getSQLReplacement(ReportQuerys.SQL_3_2_1_MUN_SubGrupoOTROS, user.getIdEntidad(), anno.toString());
       db.executeQuery(sql);
       if(!db.isEmpty())
       {
           mun = db.getValueAt(0,0).toString();
       ...
       //Totales  //              //                    //               //             //                    //
           ...
           double anchoref = 0;
           double suptotzon = 0;
           sql = getSQLReplacement(ReportQuerys.SQL_3_2_1_MUN_US_SubValues, user.getIdEntidad(), anno.toString());
           db.executeQuery(sql);
           if(!db.isEmpty())
           {
           ...
           sql = getSQLReplacement(ReportQuerys.SQL_3_2_1_MUN_AP_SubValues, user.getIdEntidad(), anno.toString());
           db.executeQuery(sql);
           if(!db.isEmpty())
           {
               longperm += Double.parseDouble(db.getValueAt(0,0).toString());
           ...
           sql = getSQLReplacement(ReportQuerys.SQL_3_2_1_MUN_OTROS_SubValues, user.getIdEntidad(), anno.toString());
           db.executeQuery(sql);
           if(!db.isEmpty())
           {
               longperm += Double.parseDouble(db.getValueAt(0,0).toString());
...
protected TableModel getModel_PROV()
{
   ...
   DefaultTableModel deftm = new DefaultTableModel(columNames, 0);
           ...
           String sql = ReportQuerys.SQL_3_2_1_MUN_US_SubValues.replaceFirst("where municipios.id", "where provincias.id");
           sql = getSQLReplacement(sql, user.getIdEntidad(), anno.toString());
           db.executeQuery(sql);
           if(!db.isEmpty())
            updateProvincia_HASH(hashValues);

           sql = ReportQuerys.SQL_3_2_1_MUN_AP_SubValues.replaceFirst("where municipios.id", "where provincias.id");
           sql = getSQLReplacement(sql, user.getIdEntidad(), anno.toString());
           db.executeQuery(sql);
           if(!db.isEmpty())
            updateProvincia_HASH(hashValues);

           sql = ReportQuerys.SQL_3_2_1_MUN_OTROS_SubValues.replaceFirst("where municipios.id", "where provincias.id");
           sql = getSQLReplacement(sql, user.getIdEntidad(), anno.toString());
           db.executeQuery(sql);
           if(!db.isEmpty())
            updateProvincia_HASH(hashValues);
...
protected TableModel getModel_NAC()
{
   ...
   String sql = getSQLReplacement(ReportQuerys.SQL_3_2_1_PROV_SubGrupoUS, anno.toString());
   db.executeQuery(sql);
   if(!db.isEmpty())
    updateProvincia_HASH(hashValues);

   sql = getSQLReplacement(ReportQuerys.SQL_3_2_1_PROV_SubGrupoAP, anno.toString());
   db.executeQuery(sql);
   if(!db.isEmpty())
    updateProvincia_HASH(hashValues);

   sql = getSQLReplacement(ReportQuerys.SQL_3_2_1_PROV_SubGrupoOTROS, anno.toString());
   db.executeQuery(sql);
   if(!db.isEmpty())
    updateProvincia_HASH(hashValues);
...
protected TableModel getModel_NAC_DESGLOSE()
{
 ...
 //Provincia, [ Municipio, [ Entidad, Obj_Tac_SCP] ]                                       prov            mun             ent
   ...
   String sql = ReportQuerys.SQL_3_2_1_PROV_SubGrupoUS.replaceAll("provincias.nombre", "provincias.nombre, municipios.nombre");
   ...
   sql = ReportQuerys.SQL_3_2_1_PROV_SubGrupoAP.replaceAll("provincias.nombre", "provincias.nombre, municipios.nombre");
   sql = getSQLReplacement(sql, anno.toString());
   db.executeQuery(sql);
   tipoEntidad = CONSTANTS.ENTIDAD_AREAS_PROTEGIDAS;
   if(!db.isEmpty())
   ...
   sql = ReportQuerys.SQL_3_2_1_PROV_SubGrupoOTROS.replaceAll("provincias.nombre", "provincias.nombre, municipios.nombre");
   sql = getSQLReplacement(sql, anno.toString());
   db.executeQuery(sql);
   tipoEntidad = CONSTANTS.ENTIDAD_OTROS;
   if(!db.isEmpty())
...
protected TableModel getModel_MUN_Especific_Entity(BaseUnits bu)
{
   ...
   if(bu.equals(BaseUnits.Unidad_Silvicola))
   {
    ...
    sql = getSQLReplacement(ReportQuerys.SQL_3_2_1_MUN_SubGrupoUS_Entities, user.getIdEntidad(), anno.toString());
   }
   else
   if(bu.equals(BaseUnits.Area_Protegida))
   {
    ...
    sql = getSQLReplacement(ReportQuerys.SQL_3_2_1_MUN_SubGrupoAP_Entities, user.getIdEntidad(), anno.toString());
   }
   else
   if(bu.equals(BaseUnits.Otros))
   {
    ...
    sql = getSQLReplacement(ReportQuerys.SQL_3_2_1_MUN_SubGrupoOTROS_Entities, user.getIdEntidad(), anno.toString());
   }
