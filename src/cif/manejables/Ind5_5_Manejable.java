...
import cif.gui.Criterio_5.Indicador5_5;
import cif.gui.Criterio_5.Indicador5_5_Modify;
 ...
 */
public class Ind5_5_Manejable extends Manejable
{
String tag,id;
User user;
int nf,row;
...
Object[][] result311,aprotg;
    ...
    private static final int temCa=1;
    private static final int nameEnt=0;

    public Ind5_5_Manejable(JF_Principal parent)
    {
    ...
    {
        tag = "insert";
        User usuario = Manage.getInstance().getUser();
        id = utiles.getId(getBaseUnits(), parent);
        if(id!=null)
        {
            TipoCategoria_Object []lista = DBExtraUtils.getTiposCategoriasOcupacionales();
            Indicador5_5 ind = new Indicador5_5(lista, tag, id, parent.getSelectedYear(), gettablename(), parent, usuario.getMunicipio());
    ...
    public void Modify()
    {
        ...
        if(id!=null)
        {
            C_5_5_Object []lista = DBExtraUtils.getC_5_5_Objects(tableName, parent.getSelectedYear(), user.getIdEntidad(), id);
            Indicador5_5_Modify ind = new Indicador5_5_Modify(lista, id, parent.getSelectedYear(), gettablename(), parent, user.getMunicipio());
            parent.setComponent(ind);
        }
    }
    ...
    public void Delete() {
       JTable table;
        ...
        try {
                            ...
                            if(rowsSel.length>0)
                            {
                                for (int i = 0; i <rowsSel.length; i++)
                                {
                                    if(!table.getValueAt(rowsSel[i], nameEnt).toString().equals("TOTAL") && !table.getValueAt(rowsSel[i], nameEnt).toString().equals("Sub-Total"))
                                    {
                                      ...
                                      idCat=java.lang.Integer.parseInt(DBAccess.getIde(table.getValueAt(rowsSel[i], temCa).toString(),"c5_5_catgocupacional"));
                                      where="and id_catg="+idCat+"";
            ...
            Logger.getLogger(Ind5_5_Manejable.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public JTable Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_5_5_CategoriaOcupacional, User, anno, false, bu);
    ...
    public JTable BaseUnits_Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_5_5_CategoriaOcupacional, User, anno, true, bu);
    ...
    public void DrawGraphic() 
    {
      ...
      BaseUnits bu = getBaseUnits();
            ...
            try {
                 ...
                 GraphicManager.mostrar_Grafico(ReportManager.C_5_5_CategoriaOcupacional, usuario, bu);
    ...
    private String gettablename()
    {
        ...
        {
            tablename="c5_5_ap_catgocupacional";
        } 
        else if(getBaseUnits()==BaseUnits.Otros)
        {
            tablename="c5_5_otros_catgocupacional";
        }
        else
        {
             tablename="c5_5_us_catgocupacional";
        }
        return tablename;
    }
    ...
    public Manejable Clone() {
         return new Ind5_5_Manejable(parent);
    }
}