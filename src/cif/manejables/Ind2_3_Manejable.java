...
import cif.gui.Criterio_2.Indicador2_3;
 ...
 * @author juliette
 */
public class Ind2_3_Manejable extends Manejable{
...
private static final int nameEnt=0;
    ...
    public Ind2_3_Manejable(JF_Principal parent)
    {
    ...
    public void Insert() {
        ...
        if(id!=null)
        {
            Indicador2_3 indi23= new Indicador2_3(id,parent,gettablename(),tag,null);
            parent.setComponent(indi23);
        }
    }
        ...
        if(id!=null)
        {
            try {
                 ...
                 if(result23.length>0){
                     Indicador2_3 indi23= new Indicador2_3(id,parent,gettablename(),tag,result23);
                     parent.setComponent(indi23);
                 }
                 else
                    {
    ...
    public void Delete() {
        ...
        try {
            ...
            Logger.getLogger(Ind2_3_Manejable.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public JTable Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_2_3_BosquesManejosSilvicolas, User, anno, false, bu);
    ...
    public JTable BaseUnits_Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_2_3_BosquesManejosSilvicolas, User, anno, true, bu);
    ...
    public void DrawGraphic()
    {
      ...
      BaseUnits bu = getBaseUnits();
            ...
            try {
                 ...
                 GraphicManager.mostrar_Grafico(ReportManager.C_2_3_BosquesManejosSilvicolas, usuario, bu);
    ...
    private String gettablename()
    {
        ...
        {
            tablename="c2_3_ap_bosquesmanejslvicolas";
        } 
        else if(getBaseUnits()==BaseUnits.Otros)
        {
            tablename="c2_3_otros_bosquesmanejslvicolas";
        }
        else
        {
             tablename="c2_3_us_bosquesmanejslvicolas";
        }
        return tablename;
    }
    ...
    private Object[][] getresult() throws SQLException{
        Object[][] res23 = null;
        res23=DBAccess.selectBosqManSil(id,parent.getSelectedYear(),gettablename());
        return res23;
    }

    @Override
    public Manejable Clone() {
         return new Ind2_3_Manejable(parent);
    }
