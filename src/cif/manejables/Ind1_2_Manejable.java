...
import cif.gui.Criterio_1.Indicador1_2;
 ...
 * @author juliette
 */
public class Ind1_2_Manejable extends Manejable{
...
private static final int nameEnt=0;
    ...
    public Ind1_2_Manejable(JF_Principal parent)
    {
    ...
    public void Insert() {
        ...
        id = utiles.getId(getBaseUnits(), parent);
         if(id!=null)
         {
            Indicador1_2 indi12 = new Indicador1_2(id, parent, gettablename(), tag, null);
            parent.setComponent(indi12);
         }
    }
    ...
    public void Modify() {
        ...
        if(id!=null)
        {
            try {
                ...
                Indicador1_2 indi12= new Indicador1_2(id,parent,gettablename(),tag,result12);
                parent.setComponent(indi12);
                }
                else
                {
                ...
                Logger.getLogger(Ind1_2_Manejable.class.getName()).log(Level.SEVERE, null, ex);
            }         
        }
    }
    ...
    public JTable Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_1_2_IndiceBoscosidad, User, anno, false, bu);
    ...
    public JTable BaseUnits_Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_1_2_IndiceBoscosidad, User, anno, true, bu);
    ...
    public void DrawGraphic()
    {
      ...
      BaseUnits bu = getBaseUnits();
            ...
            try {
                 ...
                 GraphicManager.mostrar_Grafico(ReportManager.C_1_2_IndiceBoscosidad, usuario, bu);
    ...
    private Object[][] getresult() throws SQLException{
        Object[][] res12 = null;
        res12=DBAccess.selectIndBoscosidad(id,parent.getSelectedYear(),gettablename());
        return res12;
    }

    @Override
    public Manejable Clone() {
         return new Ind1_2_Manejable(parent);
    }
