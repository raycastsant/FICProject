...
import cif.gui.Criterio_1.Indicador1_3;
 ...
 * @author juliette
 */
public class Ind1_3_Manejable extends Manejable{

private String tag,id;
private User user;
private int nf,row;
private Double bn,plant;
private Object[][] result13;
private static final int nameEnt=0;



    public Ind1_3_Manejable(JF_Principal parent)
    {
    ...
    public void Insert() {
        ...
        if(id!=null)
        {
            Indicador1_3 indi13 = new Indicador1_3(id, parent, gettablename(), tag, null);
            parent.setComponent(indi13);
        }
    }
    ...
    public void Modify() {
        ...
        if(id!=null)
        {
            try {
                    ...
                    Indicador1_3 indi13= new Indicador1_3(id,parent,gettablename(),tag,result13);
                    parent.setComponent(indi13);
                    }
                    else
                    {
    ...
    public void Delete() {
        ...
        try {
            ...
            Logger.getLogger(Ind1_3_Manejable.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public JTable Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_1_3_RelacionTac, User, anno, false, bu);
    ...
    public JTable BaseUnits_Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_1_3_RelacionTac, User, anno, true, bu);
    ...
    public void DrawGraphic()
    {
      ...
      BaseUnits bu = getBaseUnits();
            ...
            try {
                 ...
                 GraphicManager.mostrar_Grafico(ReportManager.C_1_3_RelacionTac, usuario, bu);
    ...
    private String gettablename()
    {
        ...
        {
            tablename="c1_3_ap_relaciontac_scp";
        } 
        else if(getBaseUnits()==BaseUnits.Otros)
        {
            tablename="c1_3_otros_relaciontac_scp";
        }
        else
        {
             tablename="c1_3_us_relaciontac_scp";
        }
        return tablename;
    }
    ...
    private Object[][] getresult() throws SQLException{
        Object[][] res13 = null;
        res13=DBAccess.selectRelTACSCF(id,parent.getSelectedYear(),gettablename());
        return res13;
    }

    @Override
    public Manejable Clone() {
         return new Ind1_3_Manejable(parent);
    }
