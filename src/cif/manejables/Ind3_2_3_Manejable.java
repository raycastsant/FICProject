...
import cif.gui.Criterio_3.Indicador3_2_3;
 ...
 * @author juliette
 */
public class Ind3_2_3_Manejable extends Manejable{
...
private static final int nameEnt=0;
    ...
    public Ind3_2_3_Manejable(JF_Principal parent)
    {
    ...
    public void Insert() {
        ...
        if(id!=null)
         {
            Indicador3_2_3 indi323 = new Indicador3_2_3(id, parent, gettablename(), tag, null);
            parent.setComponent(indi323);
        }
    }
        ...
        if(id!=null)
        {
            try {
                ...
                if(result323.length>0){
                    Indicador3_2_3 indi323= new Indicador3_2_3(id,parent,gettablename(),tag,result323);
                    parent.setComponent(indi323);
                }
                else
                    {
                ...
                Logger.getLogger(Ind3_2_3_Manejable.class.getName()).log(Level.SEVERE, null, ex);
            }           
        }
    }
    ...
    public JTable Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_3_2_3_CorrienteFluvial, User, anno, false, bu);
    ...
    public JTable BaseUnits_Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_3_2_3_CorrienteFluvial, User, anno, true, bu);
    ...
    public void DrawGraphic() 
    {
      ...
      BaseUnits bu = getBaseUnits();
            ...
            try {
                 ...
                 GraphicManager.mostrar_Grafico(ReportManager.C_3_2_3_CorrienteFluvial, usuario, bu);
    ...
    private String gettablename()
    {
        ...
        {
            tablename="c3_2_3_ap_corrfluvial";
        } 
        else if(getBaseUnits()==BaseUnits.Otros)
        {
            tablename="c3_2_3_otros_corrfluvial";
        }
        else
        {
             tablename="c3_2_3_us_corrfluvial";
        }
        return tablename;
    }
    ...
    private Object[][] getresult() throws SQLException{
        Object[][] res323 = null;
        res323=DBAccess.selectCorrFluvial(id,parent.getSelectedYear(),gettablename());
        return res323;
    }

    @Override
    public Manejable Clone() {
         return new Ind3_2_3_Manejable(parent);
    }
