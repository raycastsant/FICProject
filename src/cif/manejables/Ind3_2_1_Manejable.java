...
import cif.gui.Criterio_3.Indicador3_2_1;
 ...
 * @author juliette
 */
public class Ind3_2_1_Manejable extends Manejable{
...
private static final int nameEnt=0;
    ...
    public Ind3_2_1_Manejable(JF_Principal parent)
    {
    ...
    public void Insert() {
        ...
        if(id!=null)
        {
            Indicador3_2_1 indi321 = new Indicador3_2_1(id, parent, gettablename(), tag, null);
            parent.setComponent(indi321);
        }
    }
        ...
        if(id!=null)
        {
            try {
                ...
                if(result16.length>0){
                    Indicador3_2_1 indi321= new Indicador3_2_1(id,parent,gettablename(),tag,result16);
                    parent.setComponent(indi321);
                }
                else
                    {
                ...
                Logger.getLogger(Ind3_2_1_Manejable.class.getName()).log(Level.SEVERE, null, ex);
            }           
        }
    ...
    public JTable Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_3_2_1_Presas, User, anno, false, bu);
    ...
    public JTable BaseUnits_Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_3_2_1_Presas, User, anno, true, bu);
    ...
    public void DrawGraphic() 
    {
      ...
      BaseUnits bu = getBaseUnits();
            ...
            try {
                 ...
                 GraphicManager.mostrar_Grafico(ReportManager.C_3_2_1_Presas, usuario, bu);
    ...
    private String gettablename()
    {
        ...
        {
            tablename="c3_2_1_ap_presas";
        } 
        else if(getBaseUnits()==BaseUnits.Otros)
        {
            tablename="c3_2_1_otros_presas";
        }
        else
        {
             tablename="c3_2_1_us_presas";
        }
        return tablename;
    }
    ...
    private Object[][] getresult() throws SQLException{
        Object[][] res321 = null;
        res321=DBAccess.selectPresas(id,parent.getSelectedYear(),gettablename());
        return res321;
    }

    @Override
    public Manejable Clone() {
         return new Ind3_2_1_Manejable(parent);
    }
