...
import cif.gui.Criterio_1.Indicador1_6;
 ...
 * @author juliette
 */
public class Ind1_6_Manejable extends Manejable{
...
/*    private double arbext;
    ...
    public Ind1_6_Manejable(JF_Principal parent)
    {
    ...
    public void Insert() {
        ...
        if(id!=null)
        {
            Indicador1_6 indi16 = new Indicador1_6(id, parent, gettablename(), tag, null);
            parent.setComponent(indi16);
        }
    }
        ...
        if(id!=null)
        {
           try {
                ...
                if(result16.length>0){
                    Indicador1_6 indi16= new Indicador1_6(id,parent,gettablename(),tag,result16);
                    parent.setComponent(indi16);
                }
                else
                    {
    ...
    public void Delete() {
        ...
        try {
            ...
            Logger.getLogger(Ind1_6_Manejable.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public JTable Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_1_6_ArbolesAislados, User, anno, false, bu);
    ...
    public JTable BaseUnits_Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_1_6_ArbolesAislados, User, anno, true, bu);
    ...
    public void DrawGraphic()
    {
      ...
      BaseUnits bu = getBaseUnits();
            ...
            try {
                 ...
                 GraphicManager.mostrar_Grafico(ReportManager.C_1_6_ArbolesAislados, usuario, bu);
    ...
    private String gettablename()
    {
        ...
        {
            tablename="c1_6_ap_arbolesaislados";
        } 
        else if(getBaseUnits()==BaseUnits.Otros)
        {
            tablename="c1_6_otros_arbolesaislados";
        }
        else
        {
             tablename="c1_6_us_arbolesaislados";
        }
        return tablename;
    }
    ...
    private Object[][] getresult() throws SQLException{
        Object[][] res16 = null;
        res16=DBAccess.selectArbAisl(id,parent.getSelectedYear(),gettablename());
        return res16;
    }

    @Override
    public Manejable Clone() {
         return new Ind1_6_Manejable(parent);
    }
