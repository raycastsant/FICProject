...
import cif.gui.Criterio_3.Indicador3_2_2;
 ...
 * @author juliette
 */
public class Ind3_2_2_Manejable extends Manejable{
...
private static final int nameEnt=0;
    ...
    public Ind3_2_2_Manejable(JF_Principal parent)
    {
    ...
    public void Insert() {
        ...
        if(id!=null)
         {
            Indicador3_2_2 indi322 = new Indicador3_2_2(id, parent, gettablename(), tag, null);
            parent.setComponent(indi322);
        }
    }
    ...
    public void Modify() {
        ...
        if(id!=null)
        {
            try {
                    result322=getresult();
                    if(result322.length>0){
                        Indicador3_2_2 indi322= new Indicador3_2_2(id,parent,gettablename(),tag,result322);
                        parent.setComponent(indi322);
            }
                    else
                    {
                ...
                Logger.getLogger(Ind3_2_2_Manejable.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public JTable Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_3_2_2_MicroPresas, User, anno, false, bu);
    ...
    public JTable BaseUnits_Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_3_2_2_MicroPresas, User, anno, true, bu);
    ...
    public void DrawGraphic() 
    {
      ...
      BaseUnits bu = getBaseUnits();
            ...
            try {
                 ...
                 GraphicManager.mostrar_Grafico(ReportManager.C_3_2_2_MicroPresas, usuario, bu);
    ...
    private String gettablename()
    {
        ...
        {
            tablename="c3_2_2_ap_micropresas";
        } 
        else if(getBaseUnits()==BaseUnits.Otros)
        {
            tablename="c3_2_2_otros_micropresas";
        }
        else
        {
             tablename="c3_2_2_us_micropresas";
        }
        return tablename;
    }
    ...
    private Object[][] getresult() throws SQLException{
        Object[][] res322 = null;
        res322=DBAccess.selectMicroPresas(id,parent.getSelectedYear(),gettablename());
        return res322;
    }

    @Override
    public Manejable Clone() {
         return new Ind3_2_2_Manejable(parent);
    }
