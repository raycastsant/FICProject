...
import cif.gui.Criterio_5.Indicador5_2;
 ...
 * @author juliette
 */
public class Ind5_2_Manejable extends Manejable{
...
private static final int nameEnt=0;
    ...
    public Ind5_2_Manejable(JF_Principal parent)
    {
    ...
    public void Insert() {
        ...
        if(id!=null)
        {
            Indicador5_2 indi52 = new Indicador5_2(id, parent, gettablename(), tag, null);
            parent.setComponent(indi52);
        }
    }
        ...
        if(id!=null)
        {
           try {
                ...
                if(result52.length>0){
                    Indicador5_2 indi52= new Indicador5_2(id,parent,gettablename(),tag,result52);
                    parent.setComponent(indi52);
                }
                else
                    {
                ...
                Logger.getLogger(Ind5_2_Manejable.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public JTable Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_5_2_Accidentes, user, anno, false, bu);
    ...
    public JTable BaseUnits_Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_5_2_Accidentes, user, anno, true, bu);
    ...
    public void DrawGraphic() 
    {
      ...
      BaseUnits bu = getBaseUnits();
            ...
            try {
                 ...
                 GraphicManager.mostrar_Grafico(ReportManager.C_5_2_Accidentes, usuario, bu);
    ...
    private String gettablename()
    {
        ...
        {
            tablename="c5_2_ap_accidentes";
        } 
        else if(getBaseUnits()==BaseUnits.Otros)
        {
            tablename="c5_2_otros_accidentes";
        }
        else
        {
             tablename="c5_2_us_accidentes";
        }
        return tablename;
    }
    ...
    private Object[][] getresult() throws SQLException{
        Object[][] res52 = null;
        res52=DBAccess.selectAccidente(id,parent.getSelectedYear(),gettablename());
        return res52;
    }

    @Override
    public Manejable Clone() {
         return new Ind5_2_Manejable(parent);
    }
