 ...
 * @author juliette
 */
public class Ind3_1_2_Manejable extends Manejable{
...
Double bn,plant;
Object[][] result312;
private static final int temEE=1;
private static final int nameEnt=0;

    public Ind3_1_2_Manejable(JF_Principal parent)
    {
    ...
    public void Insert() {
        ...
        if(id!=null)
        {
            Indicador3_1_2 indi312= new Indicador3_1_2(id,parent,gettablename(),tag,null);
            parent.setComponent(indi312);
        }
    }
    ...
    public void Modify() {
        ...
        {     
            try {
                    result312 =getresult();
                    if(result312.length>0){
                    Indicador3_1_2_Mod indi312= new Indicador3_1_2_Mod(id,parent,gettablename(),result312);
                    parent.setComponent(indi312);
                    }
                    else
                    {
                    ...
                    Logger.getLogger(Ind3_1_2_Manejable.class.getName()).log(Level.SEVERE, null, ex);
                }
            }       
    }
                            ...
                            if(rowsSel.length>0)
                            {
                                for (int i = 0; i <rowsSel.length; i++)
                                {
                                    if(!table.getValueAt(rowsSel[i], nameEnt).toString().equals("TOTAL") && !table.getValueAt(rowsSel[i], nameEnt).toString().equals("Sub-Total"))
                                    {
                                      ...
                                      idEE=java.lang.Integer.parseInt(DBAccess.getIde(table.getValueAt(rowsSel[i], temEE).toString(),"c3_1_2_especendem"));
                                      where="and id_espendm="+idEE+"";
    ...
    public JTable Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_3_1_2_EspeciesEndemicas, User, anno, false, bu);
    ...
    public JTable BaseUnits_Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_3_1_2_EspeciesEndemicas, User, anno, true, bu);
    ...
    public void DrawGraphic() 
    {
      ...
      BaseUnits bu = getBaseUnits();
            ...
            try {
                 ...
                 GraphicManager.mostrar_Grafico(ReportManager.C_3_1_2_EspeciesEndemicas, usuario, bu);
    ...
    private String gettablename()
    {
        ...
        {
            tablename="c3_1_2_ap_especendem";
        } 
        else if(getBaseUnits()==BaseUnits.Otros)
        {
            tablename="c3_1_2_otros_especendem";
        }
        else
        {
             tablename="c3_1_2_us_especendem";
        }
        return tablename;
    }
    ...
    private Object[][] getresult() throws SQLException{
        Object[][] res11 = null;
        res11=DBAccess.selectEspEndm(id,parent.getSelectedYear(),gettablename());
        return res11;
    }

    @Override
    public Manejable Clone() {
        return new Ind3_1_2_Manejable(parent);
    }
