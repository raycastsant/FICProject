...
import cif.gui.Criterio_4.Indicador4_2;
 ...
 * @author juliette
 */
public class Ind4_2_Manejable extends Manejable{
...
private static final int nameEnt=0;
    ...
    public Ind4_2_Manejable(JF_Principal parent)
    {
    ...
    public void Insert() {
        ...
        if(id!=null)
        {
            Indicador4_2 indi42 = new Indicador4_2(id, parent, gettablename(), tag, null);
            parent.setComponent(indi42);
        }
    }
        ...
        if(id!=null)
        {
           try {
                ...
                if(result42.length>0){
                    Indicador4_2 indi42= new Indicador4_2(id,parent,gettablename(),tag,result42);
                    parent.setComponent(indi42);
                }
                else
                    {
    ...
    public JTable Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_4_2_PorcMadeXtrBosqNat, user, anno, false, bu);
    ...
    public JTable BaseUnits_Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_4_2_PorcMadeXtrBosqNat, user, anno, true, bu);
    ...
    public void DrawGraphic() 
    {
      ...
      BaseUnits bu = getBaseUnits();
            ...
            try {
                 ...
                 GraphicManager.mostrar_Grafico(ReportManager.C_4_2_PorcMadeXtrBosqNat, usuario, bu);
    ...
    private String gettablename()
    {
        ...
        {
            tablename="c4_2_ap_porcmadextrbosqnat";
        } 
        else if(getBaseUnits()==BaseUnits.Otros)
        {
            tablename="c4_2_otros_porcmadextrbosqnat";
        }
        else
        {
             tablename="c4_2_us_porcmadextrbosqnat";
        }
        return tablename;
    }
    ...
    private Object[][] getresult() throws SQLException{
        Object[][] res42 = null;
        res42=DBAccess.selectPorcMadExtrBosqNat(id,parent.getSelectedYear(),gettablename());
        return res42;
    }

    @Override
    public Manejable Clone() {
         return new Ind4_2_Manejable(parent);
    }
