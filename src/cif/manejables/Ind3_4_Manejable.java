...
import cif.gui.Criterio_3.Indicador3_4;
 ...
 * @author juliette
 */
public class Ind3_4_Manejable extends Manejable{
...
private static final int nameEnt=0;
    ...
    public Ind3_4_Manejable(JF_Principal parent)
    {
    ...
    public void Insert() {
        ...
        if(id!=null)
         {
            Indicador3_4 indi34 = new Indicador3_4(id, parent, gettablename(), tag, null);
            parent.setComponent(indi34);
        }
    }
        ...
        if(id!=null)
        {
            try {
                 ...
                 if(result34.length>0){
                     Indicador3_4 indi34= new Indicador3_4(id,parent,gettablename(),tag,result34);
                     parent.setComponent(indi34);
                 }
                 else
                    {
                ...
                Logger.getLogger(Ind3_4_Manejable.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public JTable Report()
    {
     ...
     int anno = parent.getSelectedYear();
        ...
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_3_4_AreasAfectActvMinera, User, anno, false, bu);
    ...
    public JTable BaseUnits_Report()
    {
     ...
     int anno = parent.getSelectedYear();
        try {
            table = ReportManager.mostrar_Reporte(ReportManager.C_3_4_AreasAfectActvMinera, User, anno, true, bu);
    ...
    public void DrawGraphic() 
    {
      ...
      BaseUnits bu = getBaseUnits();
            ...
            try {
                 ...
                 GraphicManager.mostrar_Grafico(ReportManager.C_3_4_AreasAfectActvMinera, usuario, bu);
    ...
    private String gettablename()
    {
        ...
        {
            tablename="c3_4_ap_areasafectactvminera";
        } 
        ...
        {
             tablename="c3_4_us_areasafectactvminera";
        }
        return tablename;
    }
    ...
    private Object[][] getresult() throws SQLException{
        Object[][] res34 = null;
        res34=DBAccess.selectActvMinera(id,parent.getSelectedYear(),gettablename());
        return res34;
    }

    @Override
    public Manejable Clone() {
         return new Ind3_4_Manejable(parent);
    }
